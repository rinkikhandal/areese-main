...
<?php include './register.php'; ?>
    ...
    ============================================= -->
    <div
      class="banner-area content-top-heading text-normal heading-weight-600 auto-height"
    >
      <div
        id="bootcarousel"
        class="carousel slide animate_text"
        data-ride="carousel"
      >
        <!-- Wrapper for slides -->
        ...
        <a
          class="left carousel-control shadow"
          href="#bootcarousel"
          data-slide="prev"
        >
        ...
        <a
          class="right carousel-control shadow"
          href="#bootcarousel"
          data-slide="next"
        >
    ...
    <section id="advisor" class="advisor-area bg-gray circle default-padding">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            <div
              class="advisor-carousel owl-carousel owl-theme text-center text-light"
            >
              <!-- Single Item -->
          ...
          <div class="event-items">
            ...
            <div class="item horizontal col-md-12">
              <div
                ...
                style="background-image: url(assets/img/1500x700.png)"
              >
                <div class="date">
            ...
            <div class="item vertical col-md-6">
              ...
              <div class="info">
                ...
                <a href="#" class="btn btn-gray btn-sm">
                  <i class="fas fa-ticket-alt"></i> 154 Available
                </a>
              </div>
            </div>
            <!-- Single Item -->
            ...
            <div class="item vertical col-md-6">
              ...
              <div class="info">
                ...
                <a href="#" class="btn btn-gray btn-sm">
                  <i class="fas fa-ticket-alt"></i> 55 Available
                </a>
              </div>
            </div>
            <!-- Single Item -->
                ...
                <div class="info">
                  ...
                  <div class="meta">
                    <ul>
                      ...
                      <li>
                        <a href="#"
                          ><i class="fas fa-comments"></i> 23 Comments</a
                        >
                      </li>
                    </ul>
                  </div>
