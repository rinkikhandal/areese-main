...
<body>
  ...
  <div class="breadcrumb-area shadow dark text-center bg-fixed text-light" style="background:white">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1>Test Series > JEE > 12<sup>th</sup> Class</h1>
          <ul class="breadcrumb">
  ...
  <div class="default-padding default-padding-per cards-with-scroll" style="margin-top: 70px;">
    <section>
      ...
      <div>
        ...
        <p>The All India Test Series (AITS) is a comprehensive mock exam series designed for 12<sup>th</sup> class students preparing for JEE (Main).</p>
        <span>
    ...
    <section>
      ...
      <div>
        ...
        <button>ONLINE / OFFLINE / POSTAL</button>
        <p> The All India Test Series (AITS) is a comprehensive mock exam series designed for 12<sup>th</sup> class students preparing for JEE (Advanced).</p>
        <span>
    ...
    <section>
      ...
      <div>
        ...
        <button>ONLINE / OFFLINE / POSTAL</button>
        <p>The All India Test Series (AITS) is a comprehensive mock exam series designed for 12<sup>th</sup> class students preparing for JEE (Main + Advanced). </p>
        <span>
    ...
    <section>
      ...
      <div>
        ...
        <button>ONLINE / OFFLINE / POSTAL</button>
        <p>The All India Test Series (AITS) is a comprehensive mock exam series designed for 12<sup>th</sup> class students preparing for BITSAT.</p>
  ...
  <div class=" default-padding-per  courses-offer">
    ...
    <div class="course-holder">
      ...
      <section class="cards left" id="11class">
        <div class="inner-container">
          <div class="upper-part">
            <h4>One year Test Series(Main) </h4>
      ...
      <section class="cards " id="12class">
        <div class="inner-container">
          <div class="upper-part">
            <h4>One year Test Series(Advance) </h4>
            <p>(11th to 12th Moving Students)</p>
      ...
      <section class="cards left" id="dropper">
        <div class="inner-container">
          <div class="upper-part">
            <h4>One year Test Series(Main + Advance)</h4>
            <p>(11th to 12th Moving Students)</p>
            <h5>About the Test Series</h5>
      ...
      <section class="cards " id="dropperPlus">
        <div class="inner-container">
          ...
          <div class="upper-part">
            <h4>One year Test Series(BITSAT)</h4>
            <p>(11th to 12th Moving Students)</p>
            <h5>About the Test Series</h5>
