  ...
  formInstance.addEventListener("submit", function (event) {
    ...
    const submitData = async (url, data) => {
      try {
        ...
        const displayMessages = (messages, className) => {
        ...
        if (responseData.errors) {
          displayMessages(responseData.errors, "alert alert-error-p");
        } else if (responseData.success) {
          displayMessages(responseData.success, "alert alert-success-p");
