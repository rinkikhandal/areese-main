...
<body>
  ...
  <div class="breadcrumb-area shadow dark text-center bg-fixed text-light" style="background:white">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1>Test Series > JEE > 12<sup>th</sup> Pass</h1>
          <ul class="breadcrumb">
  ...
  <div class="default-padding default-padding-per cards-with-scroll" style="margin-top: 70px;">
    <section>
      ...
      <div>
        ...
        <p>The All India Test Series (AITS) is a comprehensive mock exam series designed for 12th pass students preparing for JEE (Main).</p>
        <span>
    ...
    <section>
      ...
      <div>
        ...
        <button>ONLINE / OFFLINE / POSTAL</button>
        <p> The All India Test Series (AITS) is a comprehensive mock exam series designed for 12th pass students preparing for JEE (Advanced).</p>
        <span>
    ...
    <section>
      ...
      <div>
        ...
        <button>ONLINE / OFFLINE / POSTAL</button>
        <p>The All India Test Series (AITS) is a comprehensive mock exam series designed for 12th pass students preparing for JEE (Main + Advanced). </p>
        <span>
    ...
    <section>
      ...
      <div>
        ...
        <button>ONLINE / OFFLINE / POSTAL</button>
        <p>The All India Test Series (AITS) is a comprehensive mock exam series designed for 12th pass students preparing for BITSAT.</p>
