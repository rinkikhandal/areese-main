...
<body>
  ...
  <div class="results default-padding ">
    <h2 class="headings">JEE(Main) Results </h2>
    <div class="inner-container">
      <Article style="margin-bottom: 70px;" id="growth">
        <img src="./assets/img/jee-main-main-result.jpg" alt="growth">
      </Article>
      <Article id="result">
        <img src="./assets/img/JEE-MAINS-GROWTH.png" alt="results">
      </Article>
  ...
  <!-- ./assets/img/NEET-result.png -->
  <!-- ./assets/img/result-poster.jpg -->
