...
<body>
  ...
  <div class="breadcrumb-area shadow dark text-center bg-fixed text-light" style="background:white">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1>Classroom > 11<sup>th</sup> School Exams </h1>
          <ul class="breadcrumb">
      ...
      <section class="cards" style="padding-top: 30px;">
        <div class="inner-container">
          ...
          <div class="upper-part">
            ...
            <h5 style="margin-bottom:10px">11TH CLASS OFFLINE BATCH SCIENCE STREAM</h5>
      ...
      <section class="cards ">
        <div class="inner-container">
          <div class="upper-part">
            ...
            <h5>11TH CLASS OFFLINE BATCH COMMERCE STREAM</h5>
