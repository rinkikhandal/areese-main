...
<body>
  ...
  <div class="results default-padding ">
    <h2 class="headings" style="text-align: center;">JEE(Advance) Results </h2>
    <div class="inner-container">
      <Article style="margin-bottom: 70px;" id="growth">
        <img src="./assets/img/JEE-adv-result.png" alt="results">
      </Article>
      <Article id="result">
        <img src="./assets/img/adv-main-result.jpg" alt="growth">
      </Article>
